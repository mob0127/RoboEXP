...
from experiments.cup_dynamic_demo_pr2 import (
    set_pr2_root, add_test_cup, HOME_CONF, REACH_CONF, PRE_GRASP_CONF,
    GRASP_CONTACT_CONF, LIFT_CONF, move_arm_to_conf, open_gripper_pr2,
    close_gripper_pr2, attach_cup_pr2, detach_cup_pr2
)
...
def collisions():
    return len(p.getContactPoints(robot, counter_body))

for label, conf in [('HOME',HOME_CONF),('REACH',REACH_CONF),('PRE',PRE_GRASP_CONF),('CONTACT',GRASP_CONTACT_CONF),('LIFT',LIFT_CONF)]:
    ...
    imageio.imwrite(f'/home/jx/kitchen/RoboEXP/seq_{label}.png', img)
